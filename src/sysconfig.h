...
public:
	SysConfig() {}
	SysConfig(const lattice_id& lid, const lattice_size& size, const neuralnet_id& nid) 
		{ init(lid, size, nid); }
	~SysConfig() {}
	void init(const lattice_id& lid, const lattice_size& size,  const neuralnet_id& nid);
