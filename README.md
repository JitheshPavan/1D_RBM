...
RBM kernel matrix dimension is : 2 &times; alpha &times; n_sites,2&times; n_sites</br>
...
the no of bias parameters = 2&times;alpha. That is, we add the same number for every n_sites output. 
